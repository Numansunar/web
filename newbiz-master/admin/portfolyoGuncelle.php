...
$sonuc = $sorgu->fetch();//sorgu çalıştırılıp veriler alınıyor
       ...
       if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
            ...
            if ($baslik <> "" && $icerik <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
             ...
             $sql = "UPDATE portfolyo SET foto=:foto, baslik=:baslik,aktif=:aktif,sira=:sira, ustBaslik=:ustBaslik, icerik=:icerik WHERE id=:id;";             
            ...
            <div class="card-body">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    <div class="form-group">
                        <img src="../img/portfolio/<?= $sonuc["foto"] ?>" width="150" alt="">
