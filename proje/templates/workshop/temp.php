...
<div class="header">
	...
	<div class="wrapper">
		...
		<div class="header-left">
			<div class="support"><img src="templates/workshop/img/support.png" alt="" /> Bilgi ve Sipariş <span><?=siteConfig('firma_tel')?></span></div>
...
<div class="content">
	<div class="wrapper">
        <?
			$singleBlockArray = array('urunDetay','tumKategoriler','satinal','login');
