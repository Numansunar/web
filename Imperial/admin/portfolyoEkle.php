            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        $sql = "INSERT INTO portfolyo SET foto=:foto, grup=:grup, ustIcerik=:ustIcerik, baslik=:baslik,aktif=:aktif,sira=:sira, ustBaslik=:ustBaslik, icerik=:icerik;";
                        $durum = $baglanti->prepare($sql)->execute($satir);

                        if ($durum) {
                            echo '<script>swal("Başarılı","Portfolyo Eklendi","success").then((value)=>{ window.location.href = "portfolyo.php"});
...
<div id="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Portolyo Ekle</li>
        </ol>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form method="post" action="portfolyoEkle.php" enctype="multipart/form-data">
					...
					<div class="form-group">
                        <label>Grup</label>
                        <input required type="text" class="form-control" name="grup" placeholder="Grup">
                    </div>
                    <div class="form-group">
                        <label>Başlık</label>
