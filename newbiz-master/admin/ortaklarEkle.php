            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        $sql = "INSERT INTO ortaklar SET foto=:foto, baslik=:baslik,aktif=:aktif,sira=:sira,icerik=:icerik;";
                        $durum = $baglanti->prepare($sql)->execute($satir);
                        if ($durum) {
                            echo '<script>swal("Başarılı","Ortak Eklendi","success").then((value)=>{ window.location.href = "ortaklar.php"});
							</script>';
                        }
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form method="post" action="ortaklarEkle.php" enctype="multipart/form-data">
