...
<head>
	...
	<link href="//<?=$_SERVER['HTTP_HOST'].$siteDizini?>/affilate/css/aff250.css" rel="stylesheet" type="text/css" />
...
<div class="viewport">
	<ul class="overview">
		<?=urunlist('select * from urun where active =1 AND anasayfa=1 order by rand() limit 0,5','../../../affilate/ItemList250','../../../affilate/250x250_temp');?> 
    </ul>
    </div>
</div>
<script>
