...
<tr><td class="urunFiyat" align="right"><br>KDV DAHÝL : {%URUN_FIYAT_KDV_DAHIL%} {%URUN_FIYAT2_BIRIM%}<br><span style="font-size: 11px;" id="URUN_FIYAT_KDV_DAHIL_YTL">{%URUN_FIYAT_KDV_DAHIL_YTL%} TL</span>
</td></tr>
...
</td></tr></tbody></table><div>{%VIDEO%}</div><div class="urunTarih">Ürün kataloðumuza <b>{%URUN_EKLENME_TARIHI%}</b> tarihinde eklenmiþtir.</div>
