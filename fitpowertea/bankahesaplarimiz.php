<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="50">
		<td align="left" style="border-bottom: 1px dashed #cccccc;">&nbsp;Ödemeleriniz için çalışmakta olduğumuz tüm banka hesap bilgileri aşağıdadır</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
			...
			?>
				<td width="348">
					<table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
						<tr height="40">
							<td coslpan="4" align="center"><img src="Resimler/<?php echo DonusumleriGeriDondur($Kayit["BankaLogosu"]);?>" border="0">	
							</td>	
						</tr>
					<tr height="25">
						<td width="5">&nbsp;</td>
