...
$sonuc = $sorgu->fetch();//sorgu çalıştırılıp veriler alınıyor
    ...
    if ($_FILES["foto"]["name"] != "") {
        ...
        if (file_exists('images/' . $foto)) {
            ...
            if ($ustBaslik <> "" && $ustIcerik <> "" && $baslik <> "" && $icerik <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
                //Değişecek veriler
                $satir = [
                ...
                $sql = "UPDATE hakkimizda SET foto=:foto, ustBaslik=:ustBaslik, ustIcerik=:ustIcerik, baslik=:baslik,  icerik=:icerik WHERE id=:id;";   
