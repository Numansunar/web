    ...
    <!--THIS IS A WIDE PORTLET-->
		...
		<table width=940px cellpadding="4"  cellspacing="4" border="1" id="box-table-a">
			...
			<tr>
                ...
                <td><img src="../userfiles/catimages/productimg/<?php echo $dataprod['product_top']; ?>" height="40" width="60"></td><?php }?>
                ...
                <td><img src="../userfiles/catimages/productimg/<?php echo $dataprod['product_left']; ?>" height="40" width="60"></td><?php }?>
                                               <?php if(!empty($dataprod['product_right'])) {?>
                <td><img src="../userfiles/catimages/productimg/<?php echo $dataprod['product_right']; ?>" height="40" width="60"></td><?php }?>
