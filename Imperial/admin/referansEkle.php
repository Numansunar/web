...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
    ...
    if ($adSoyad <> "" && $icerik <> "" && isset($_FILES['foto'])) {
            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                      ...
                      $sql = "INSERT INTO referanslar SET foto=:foto, adSoyad=:adSoyad, kis=:kis,aktif=:aktif,sira=:sira, ustBaslik=:ustBaslik,ustIcerik=:ustIcerik, icerik=:icerik;";
                      $durum = $baglanti->prepare($sql)->execute($satir);
                        if ($durum) {
                            echo '<script>swal("Başarılı","Referans Eklendi","success").then((value)=>{ window.location.href = "referanslar.php"});
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form method="post" action="referansEkle.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Link</label>
                        <input required type="text" class="form-control" name="ustBaslik" placeholder="Link">
                    </div>
                    <div class="form-group">
