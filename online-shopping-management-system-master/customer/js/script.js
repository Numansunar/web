...
transnum = jQuery("#transnum").val();

	$.ajax({
        type: 'POST',
        url: 'http://localhost/easyshop/customer/ajax.php',
        data: {min_price:min_value, max_price:max_value, transnum:transnum},
        success: function(data) {
