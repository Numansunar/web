            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        $sql = "INSERT INTO takim SET foto=:foto, facebook=:facebook,linkedin=:linkedin,google=:google,instagram=:instagram,baslik=:baslik,aktif=:aktif,sira=:sira, icerik=:icerik;";
                        $durum = $baglanti->prepare($sql)->execute($satir);

                        if ($durum) {
                            echo '<script>swal("Başarılı","takim Eklendi","success").then((value)=>{ window.location.href = "takim.php"});
            ...
            <div class="card-body">
                ...
                <form method="post" action="takimEkle.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="instagram" placeholder="İnstagram">
                    </div>
                    <div class="form-group">
                        <label>Linkedin</label>
                        <input required type="text" class="form-control" name="linkedin" placeholder="Linkedin">
                    </div>
                    <div class="form-group">
                        <label>Google</label>
                        <input required type="text" class="form-control" name="google" placeholder="Google">
                    </div>
