...
<div class="footer_content">
	<div class="footer1">
		...
		<ul>
			...
			<li><a href="index.php?page=category&cat_id=<?php echo $data2['cat_id']; ?>">Shoes</a></li>
			<li><a href="index.php?page=category&cat_id=<?php echo $data2['cat_id']; ?>">Electronics</a></li>	
			<li><a href="index.php?page=category&cat_id=<?php echo $data2['cat_id']; ?>">Accessories</a></li>	
			<li><a href="index.php?page=category&cat_id=<?php echo $data2['cat_id']; ?>">Fashion</a></li>	
	...
	<div class="footer2">
		<ul>
			...
			<hr>
			<li><a href="index.php?page=contact">Help and Support</a></li>
			<li><a href="index.php?page=contact">Delivery Information</a></li>
			<li><a href="index.php?page=contact">Contact Info</a></li>
			<li><a href="index.php?page=contact">Shipping and Returns</a></li>
			<li><a href="index.php?page=contact">Secure Shopping</a></li>
		</ul>
	</div>
	<div class="footer3">
		<ul>
			...
			<li><a href="index.php?page=team">Responsible Disclosure Policy</a></li>
			<li><a href="index.php?page=howtoshop">How To shop</a></li>
			<li><a href="index.php?page=contact">Contact US</a></li>
			<li><a href="index.php?page=contact">Survey</a></li>
		</ul>
	</div>
	<div class="footer4">
		<div class="footer41">
			<ul>
				<li><h2>Account</h2></li>
				<hr>
				<li><a href="http://localhost/easyshop/main.php#login_form">Login</a></li>
				<li><a id=user class="icon icon-lock" href="do_logoff.php">Logout</a></li>
			</ul>
		</div>
		<div class="footer42">
			<ul>
