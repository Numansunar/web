...
<div class="product-container">
	...
	<div class="catalog-item-ribbons hidden-xs">
		...
		<a href="{%URUN_DETAY_LINK%}" class="imgLink">
			...
			<img class="owl-lazy" alt="{%DB_NAME%}" src="templates/orion/images/placeholder.jpg" data-src="resizer/400x400/2/images/urunler/{%DB_RESIM%}">
		</a>
	</div>
