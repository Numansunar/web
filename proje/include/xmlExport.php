...
function buildentegrasiparislerXMLFile()
{
	...
	$q = my_mysql_query("select * from siparis where durum >= 1 $f order by ID desc limit 0,500");
			...
			while ($d = my_mysql_fetch_array($q)) {
				...
				if ($d['varID1'] || $d['varID2']) {
					...
					while ($vd = my_mysql_fetch_array($vq)) {
						...
						$vAttr->addChild('Deger', $var1);
						$vAttr->addChild('Tanim', cleanstr($vd['var1']));
						$vAttr->addChild('FiyatFarkiMi', true);
						$vAttr->addChild('Fiyat', 0);
						if ($vd['var2']) {
							$vAttr = $attr->addChild('VariantAttr');
							$vAttr->addChild('Deger', $var2);
							$vAttr->addChild('Tanim', cleanstr($vd['var2']));
							$vAttr->addChild('FiyatFarkiMi', true);
				...
				for ($j = 1; $j <= 5; $j++) {
					...
					if ($d[$resimStr])
						$channel->addChild('UrunResim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d[$resimStr]));
				}
			}
...
function insertXMLData($string, $value, $charset = 'UTF-8')
{
	...
	switch ($_GET['type']) {
		...
		default:
			...
			while ($d = my_mysql_fetch_array($q)) {
				...
				$channel->addChild('Barcode', ($d['tedarikciCode']));
				...
				if ($d['varID1'] || $d['varID2']) {
					...
					while ($vd = my_mysql_fetch_array($vq)) {
						...
						$var->addChild('VariantPrice', $price);
				...
				for ($j = 1; $j <= 5; $j++) {
					$resimStr = 'resim' . ($j == 1 ? '' : $j);
					if ($d[$resimStr])
						$channel->addChild('urun_resim' . $j, ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d[$resimStr]));
				}
...
function buildStockmountXMLFile_()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		if ($d['resim']) $channel->addChild('Image1', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
		if ($d['resim2']) $channel->addChild('Image2', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim2']));
		if ($d['resim3']) $channel->addChild('Image3', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim3']));
		if ($d['resim4']) $channel->addChild('Image4', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim4']));
		if ($d['resim5']) $channel->addChild('Image5', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim5']));
		if ($d['resim6']) $channel->addChild('Image6', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim6']));
		if ($d['resim7']) $channel->addChild('Image7', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim7']));
		if ($d['resim8']) $channel->addChild('Image8', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim8']));
		if ($d['resim9']) $channel->addChild('Image9', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim9']));
		if ($d['resim10']) $channel->addChild('Image19', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim10']));
...
function buildKliksaXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml->addChild('MainImageUrl', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
		$sub = $xml->addChild('SubImages');
		for ($i = 2; $i <= 5; $i++) {
			if ($i > 1) $n = $i;
			else $n = '';
			if ($d['resim' . $n]) $sub->addChild('Image' . $i, ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim' . $n]));
		}
...
function buildCiceksepetiXMLFile()
{
	...
	$q = my_mysql_query("select urun.*,kategori.namePath as catName,kategori.cscode as cscode,marka.name as markaName,kategori.namePath as namePathx,kategori.parentID as catParentID from urun,kategori,marka where urun.noxml != 1 AND kategori.noxml != 1 AND urun.catID=kategori.ID AND marka.ID = urun.markaID AND catID!=0 AND markaID!=0 AND fiyat > 0 AND stok>0 AND bakiyeOdeme=0 AND urun.active = 1 AND kategori.active =1 AND kategori.cscode != '' $filter $order $limit");
	while ($d = my_mysql_fetch_array($q)) {
		if ($d['anindaGonderim'])
			$d['kargoGun'] = 1;
		if (!$d['kargoGun'])
		...
		{
			$xml->addChild('Image1', ('http' . (siteConfig('httpsAktif')  ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
			for ($i = 2; $i <= 5; $i++) {
				$xml->addChild('Image' . ($i), ('http' . (siteConfig('httpsAktif')  ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim'.$i]));
			}
			$xarr = explode("\n",$d['cicekozellik']);
			$oi = 1;
			foreach($xarr as $o)
			...
			while($d2 = my_mysql_fetch_array($q2))
			{
				...
				$var->addChild('price', $d2['fark']);
				$var->addChild('firstprice', $d2['fark']);
				$var->addChild('buyingprice', $d2['fark']);
				...
				{
					$var->addChild('Image1', ('http' . (siteConfig('httpsAktif')  ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
					for ($i = 2; $i <= 5; $i++) {
						$var->addChild('Image' . ($i), ('http' . (siteConfig('httpsAktif')  ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim'.$i]));
					}
				}
			}
		}
...
function buildAkakceXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml->addChildWithCDATA('name', cleanStr(($d['name'])));
		$xml->addChild('url', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunLink($d)));
		$xml->addChild('imgUrl', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
		$xml->addChildWithCDATA('description', cleanStr(($d['listeDetay'] . $d['detay'])));
		$xml->addChild('distributor', '');
		$xml->addChild('price', YTLfiyat($d['fiyat'], $d['fiyatBirim']));
		$xml->addChild('shipPrice', ($d['fixKargoFiyat'] ? $d['fixKargoFiyat'] : siteConfig('kargo')));
		...
		if ($d['varID1'] || $d['varID2']) {
			...
			while ($vd = my_mysql_fetch_array($vq)) {
				...
				$var->addChild('price', YTLfiyat($d['fiyat'], $d['fiyatBirim']) + (YTLfiyat($price1, $d['fiyatBirim']) + YTLfiyat($price2, $d['fiyatBirim'])));
...
function buildSanalpazarXMLFile()
{
	global $siteDizini;
	$defaultXML = '<?xml version="1.0" encoding="utf-8"?><Products></Products>';
	$xmlx = new SimpleXMLElementExtended($defaultXML);
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml = $xmlx->addChild('Product', '');
		$xml->addChild('Product_id', $d['ID']);
		$xml->addChild('Name', cleanStr(($d['name'])));
		$xml->addChild('SubName', cleanStr(($d['listeDetay'])));
		$xml->addChild('Category_Tree', (cleanStr(str_replace('/', '-', $d['catName']))));
		$xml->addChild('Price', YTLfiyat($d['fiyat'], $d['fiyatBirim']));
		$xml->addChild('CurrencyType', 'TL');
		$xml->addChild('Tax', ($d['kdv'] * 100));
		$xml->addChild('Stock', $d['stok']);
		$xml->addChild('Brand', (str_replace('&prime;', '', $d['markaName'])));
		for ($i = 1; $i <= 5; $i++) {
			...
			if ($d['resim' . $n]) $xml->addChild('Image' . $i, ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim' . $n]));
		}
		$xml->addChild('Description', (cleanStr($d['onDetay'] . $ozellikler) . htmlspecialchars($d['detay'], ENT_COMPAT, 'UTF-8', true)));
	}
	$xmlx->saveXML(xmlCacheFilename());
...
function buildAkilliFiyatXMLFile_CatProducts($catid)
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml .= insertXMLData('url', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . '' . seoFix($d['name']) . '-urun' . $d['ID'] . '.html');
		$xml .= insertXMLData('image', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']);
...
function buildCimriXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml .= insertXMLData('itemTitle', ($d['name']), 'UTF-8');
		$xml .= insertXMLData('itemUrl', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunLink($d), 'UTF-8');
		for ($j = 3; $j <= 12; $j = $j + 3) {
			$type = '';
		...
		$xml .= insertXMLData('itemImageUrl', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim'] . '');
		$type = '';
		...
		$xml .= insertXMLData('shippingFee', $d['fixKargoFiyat']);
...
function buildHizlialXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml .= insertXMLData('LINK', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunLink($d));
		$aciklama = ($d['onDetay'] . ' ' . $d['detay']);
		$xml .= insertXMLData('ACIKLAMA', trim(utf8fix($aciklama)));
		$xml .= insertXMLData('KUCUK_RESIM', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'include/resize.php?path=images/urunler/' . $d['resim'] . '&width=100&height=500');
		$xml .= insertXMLData('BUYUK_RESIM', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']);
		for ($i = 2; $i <= 5; $i++) {
			if ($d['resim' . $i]) $xml .= insertXMLData('BUYUK_RESIM' . $i, 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim' . $i]);
		}
...
function buildBayiCepteXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		for ($j = 1; $j <= 10; $j++) {
			$resimStr = 'resim' . ($j == 1 ? '' : $j);
			if ($d[$resimStr])
				$channel->addChild('resim' . $j, ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d[$resimStr]));
		}
...
function buildUcuzcuXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$channel->addChild('url', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunLink($d)));
		$fiyat = YTLfiyat($d['fiyat'], $d['fiyatBirim']);
		...
		$channel->addChild('resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
...
<shop>';
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml .= insertXMLData('link', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunLink($d));
		$xml .= insertXMLData('resim', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']);
		$xml .= '</urun>' . "\n";
	}
	$xml .= '</shop>';
	return $xml;
...
function buildFbfXMLFile()
{
	...
	$xml = new SimpleXMLElementExtended($defaultXML);
	$q = my_mysql_query('select * from urun where stok > 0 AND start < now() AND finish > now() order by seq desc,start asc');
	while ($d = my_mysql_fetch_array($q)) {
		$d['name'] = cleanstr($d['name']);
		$d['detay'] = cleanstr($d['detay']);
		$d['onDetay'] = cleanstr($d['onDetay']);
		...
		$channel->addChild('dealUrl', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'index.php?urunID=' . $d['ID'] . '&amp;ref=' . ($_GET['ref'] ? $_GET['ref'] : 'firsatbufirsat')));
		$channel->addChild('imageUrl', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
		/*
...
{
	global $siteDizini;
	$defaultXML = '<Icerik xmlns:i="http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://www.w3.org/2001/XMLSchema-instance" xmlns="http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://schemas.datacontract.org/2004/07/Hurriyet.SerialAds.Library.Data.Model"></Icerik>';
	$xml = new SimpleXMLElementExtended($defaultXML);
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$kargo->addAttribute('xmlns:d4p1', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://schemas.microsoft.com/2003/10/Serialization/Arrays');
		...
		$foto->addAttribute('xmlns:d4p1', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://schemas.microsoft.com/2003/10/Serialization/Arrays');
		for ($j = 1; $j <= 5; $j++) {
			$resimStr = 'resim' . ($j == 1 ? '' : $j);
			if ($d[$resimStr])
				$foto->addChild('d4p1:string', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d[$resimStr]));
		}
	}
	$out = $xml->asXML();
...
function buildYurticikargosiparislerXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$channel->addChild('town', hq("select name from ilceler where plakaID='" . $d['semt'] . "'"));
		$channel->addChild('phone_work', ($d['istel']));
		$channel->addChild('phone_gsm', ($d['ceptel']));
		$channel->addChild('email_address', cleanStr($d['email']));
		$channel->addChild('tax_number', cleanStr($d['tckNo']));
		$channel->addChild('cargo_type', 1);
		$channel->addChild('payment_type', 0);
...
function buildBirfaturasiparislerXMLFile()
{
	...
	if ($_GET['start-date'])
		$f = ' AND tarih >= \'' . $_GET['start-date'] . '\' AND tarih <= \'' . $_GET['finish-date'] . '\'';
	$q = my_mysql_query("select * from siparis where durum >= 0 AND durum < 80 AND tarih > '" . date('Y-m-d H:i:s', mktime(date('H'), date('i'), (date('s')), date('m'), (date('d') - ((int) $_GET['gun'] ? (int) $_GET['gun'] : 365)), date('Y'))) . "' $f");
	while ($d = my_mysql_fetch_array($q)) {
		$channel = $xml->addChild('SIPARIS', '');
		list($tarih, $zaman) = explode(' ', $d['tarih']);
		...
		$channel->addChild('VergiNo', $d['vergiNo']);
		$channel->addChild('TeslimTCKNo', cleanStr($d['tckNo']));
		$channel->addChild('KampanyaKodu', cleanStr($d['tckNo']));
		...
		$channel->addChild('NET_TOPLAM', str_replace(',', '', my_money_format('', $d['toplamKDVDahil'])));
		$channel->addChild('KargoUcreti', str_replace(',', '', my_money_format('', $d['kargoTutar'] + $d['degisimYTL'])));
...
function buildBannerXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$channel->addChild('BANNER_PIC', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/banner/' . $d['resimJS']));
...
function buildSliderXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$channel->addChild('resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/kampanya/' . $d['resimJS']));
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$channel->addChild('title', ($d['title']));
		$channel->addChild('resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/kampanya/' . $d['resim']));
		$channel->addChild('thumb', ($d['thumb']));
		$channel->addChild('link', ($d['link']));
		$channel->addChild('sira', ($d['seq']));
	}
...
function buildN11XMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$resimler->addChild('Resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
		if (strlen($d['resim2']) > 4) $resimler->addChild('Resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim2']));
		if (strlen($d['resim3']) > 4) $resimler->addChild('Resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim3']));
		if (strlen($d['resim4']) > 4) $resimler->addChild('Resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim4']));
		if (strlen($d['resim5']) > 4) $resimler->addChild('Resim', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim5']));
	}
	$xml->saveXML(xmlCacheFilename());
	return (file_get_contents(xmlCacheFilename()));
}
function buildDogusXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$channel->addChild('UrunID', $d['ID']);
		$channel->addChild('marka', ($d['markaName']));
		$channel->addChild('resimA', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
		if ($d['resim2']) $channel->addChild('resimB', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim2']));
		if ($d['resim3']) $channel->addChild('resimC', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim3']));
		if ($d['resim4']) $channel->addChild('resimD', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim4']));
		if ($d['resim5']) $channel->addChild('resimE', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim5']));
...
function buildrssXMLFile()
{
	...
	$xml->channel->addChild('link', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini);
	...
	switch ($_GET['type']) {
		case 'kategori':
			...
			while ($d = my_mysql_fetch_array($q)) {
				...
				$item->addChild('link', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . kategoriLink($d));
		...
		default:
			...
			while ($d = my_mysql_fetch_array($q)) {
				...
				$item->addChild('image', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
				$item->addChild('link', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . urunLink($d));
		...
		default:
			...
			while ($d = my_mysql_fetch_array($q)) {
				...
				if ($xmlMarka && (stristr($xmlMarka, ',' . $d['markaID'] . ',') === false))
					continue;
				$channel = $xml->addChild('urun', '');
				$channel->addChild('urun_url', (cleanStr('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunlink($d))));
				$channel->addChild('urun_id', ($d['ID']));
				...
				$channel->addChild('resimurl', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
		...
		default:
			...
			while ($d = my_mysql_fetch_array($q)) {
				...
				for ($j = 1; $j <= 5; $j++) {
					$resimStr = 'resim' . ($j == 1 ? '' : $j);
					if ($d[$resimStr])
						$resimler->addChild('resim' . $j, ('http' . ($siteConfig['httpsAktif'] == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d[$resimStr]));
				}
...
function buildShopphpXMLFile()
{
	...
	switch ($_GET['type']) {
		...
		default:
			...
			if ($_GET['filter']) $filter .= 'AND urun.' . $_GET['filter'] . ' = 1';
			if ($_GET['tID']) $filter .= 'AND urun.tedarikciID= ' . (int) $_GET['tID'];
			if ($_GET['namePath']) $filter .= 'AND urun.namePath like  \''.$_GET['namePath'].'%\'';
			...
			$q = my_mysql_query("select urun.*,kategori.ckar,kategori.gg_Kod,marka.name markaName,kategori.name catName from urun,kategori,marka where urun.noxml != 1 AND kategori.noxml != 1 AND urun.markaID = marka.ID AND urun.catID=kategori.ID AND catID!=0 AND markaID!=0 AND bakiyeOdeme=0 AND urun.active=1 AND kategori.active = 1  $filter $order $limit");
			while ($d = my_mysql_fetch_array($q)) {
				$gercekFiyat = $d['fiyat'];
				$d['fiyat'] = fixFiyat($d['fiyat'], 0, $d);
				if (!$_GET['facebook'])
				...
				$channel->addChild('urun_url', (('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunlink($d))));
				$channel->addChild('urun_ID', ($d['ID']));
				...
				if ($d['varID1'] || $d['varID2']) {
					...
					while ($vd = my_mysql_fetch_array($vq)) {
						...
						$var->addChild('fiyat_fark', (float)hq("select fark from urunvarstok where urunID='" . $d['ID'] . "' AND (var1 like '" . str_replace(' ', '%', $vd['var1']) . "' AND var2 like '" . str_replace(' ', '%', $vd['var2']) . "') AND up=1"));
...
function buildAdtriplexXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml->addChild('category_url', (cleanStr('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . kategorilink($d['catParentID']))));
		...
		$xml->addChild('prod_url', (cleanStr('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . urunlink($d))));
		$xml->addChild('brand', ($d['markaName']));
		$xml->addChild('model', '');
		$xml->addChild('img_large', ('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']));
...
function buildGoogleImageXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$xml .= insertXMLData('loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $urunDetayLink);
		$xml .= '<image:image>' . insertXMLData('image:loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']) . insertXMLData('image:title', htmlentities($d['name'])) . '</image:image>';
		for ($i = 2; $i <= 5; $i++) {
			if ($d['resim' . $i])
				$xml .= '<image:image>' . insertXMLData('image:loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim' . $i]) . insertXMLData('image:title', htmlentities($d['name'])) . '</image:image>';
		}
		$xml .= '</url>' . "\n";
	}
	$xml .= '</urlset>';
...
function buildGoogleXMLFile()
{
	...
	if (!$_GET['autolang'] && sizeof(getLangArr()) > 1) {
		...
		foreach ($langArr as $k => $v) {
			$out .= '<sitemap>
					<loc>http' . (siteConfig('httpsAktif') ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'ln-' . $k . '/sitemap.xml</loc>
	...
	$xml .= '<url>' . "\n";
	$xml .= insertXMLData('loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . generateLink('index.php'));
	...
	$xml .= '<url>' . "\n";
	$ssslink = slink('sss');
	$xml .= insertXMLData('loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $ssslink);
	$xml .= insertXMLData('lastmod', $date);
	...
	$start = ($_GET['start'] ? $_GET['start'] : 0);
	if ($_GET['limit']) $limit = 'limit ' . $start . ',' . (int) $_GET['limit'];
	$q = my_mysql_query("select * from urun where bakiyeOdeme=0 AND active=1 order by anasayfa desc $limit", 1);
	while ($d = my_mysql_fetch_array($q)) {
		if ($d['noxml']) continue;
		$d = translateArr($d);
		$d['detay'] = cleanstr($d['detay']);
	...
	if (!$_GET['start']) {
		...
		while ($d = my_mysql_fetch_array($q)) {
			...
			$xml .= insertXMLData('loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $kategoriLink);
			$xml .= insertXMLData('lastmod', $date);
			$xml .= insertXMLData('changefreq', 'weekly');
			$xml .= insertXMLData('priority', '0.8');
			$xml .= '</url>' . "\n";
		...
		while ($d = my_mysql_fetch_array($q)) {
			...
			if (siteConfig('seoURL') && $d['seo'])
				$href = $d['seo'];
			$xml .= insertXMLData('loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . $href);
			$xml .= insertXMLData('lastmod', $date);
		...
		while ($d = my_mysql_fetch_array($q)) {
			...
			$xml .= '<url>' . "\n";
			$href = haberLink($d);
			$xml .= insertXMLData('loc', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $href);
			$xml .= insertXMLData('lastmod', $date);
			$xml .= insertXMLData('changefreq', 'monthly');
			$xml .= insertXMLData('priority', '0.7');
			$xml .= '</url>' . "\n";
	...
	xmlDosyaYaz($file, $xml);
	file_get_contents('https://www.google.com/webmasters/tools/ping?sitemap=http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'sitemap.xml');
	return $xml;
}
function buildYandexmarketXMLFile()
{
	...
	$shop->addChild('url', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . $siteDizini);
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		$offer->addChild('url', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . (urunLink($d)));
		...
		$offer->addChild('picture', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d['resim']);
...
function buildGoogleMerchantXMLFile()
{
	...
	while ($product = my_mysql_fetch_array($q)) {
		...
		$product['name'] = ucwords(cleanstr($product['name']));
		...
		$itemNode->appendChild($doc->createElement('link'))->appendChild($doc->createTextNode('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . $url));
		...
		$itemNode->appendChild($doc->createElement('g:price'))->appendChild($doc->createTextNode(str_replace('.', ',', str_replace(',', '', my_money_format('%i', YTLfiyat($product['fiyat'], $product['fiyatBirim'])))) . ' TRY'));
		$itemNode->appendChild($doc->createElement('g:sale_price'))->appendChild($doc->createTextNode(str_replace('.', ',', str_replace(',', '', my_money_format('%i', YTLfiyat(($product['fiyat'] * (1 - ((float) siteConfig('havaleIndirim')))), $product['fiyatBirim'])))) . ' TRY'));
		...
		if($product['fixKargoFiyat'])
		{
			...
			$itemNode->appendChild($doc->createElement('g:shipping'))->appendChild($doc->createElement('g:price'))->appendChild($doc->createTextNode($sp.' TRY'));
		}

		else if($product['ucretsizKargo'])
		{
			$itemNode->appendChild($doc->createElement('g:shipping'))->appendChild($doc->createElement('g:price'))->appendChild($doc->createTextNode('0.00 TRY'));
		}
		...
		if (!$url)
			$url = 'nopic.png';
		// $itemNode->appendChild($doc->createElement('g:image_link'))->appendChild($doc->createTextNode('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'include/resize.php?path=images/urunler/' . $url));
			$itemNode->appendChild($doc->createElement('g:image_link'))->appendChild($doc->createTextNode('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $url));
	}
...
function buildFacebookproductXMLFile()
{
	...
	$channelNode->appendChild($doc->createElement('title', htmlentities($title)));
	...
	$channelNode->appendChild($doc->createElement('link', 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . $siteDizini));
	...
	while ($product = my_mysql_fetch_array($q)) {
		...
		$itemNode = $channelNode->appendChild($doc->createElement('item'));
		$itemNode->appendChild($doc->createElement('g:id'))->appendChild($doc->createTextNode($product['ID']));
		$itemNode->appendChild($doc->createElement('g:link'))->appendChild($doc->createTextNode('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER['HTTP_HOST'] . urunLink($product)));
		$itemNode->appendChild($doc->createElement('g:title'))->appendChild($doc->createTextNode(($product['name'])));
		$itemNode->appendChild($doc->createElement('g:description'))->appendChild($doc->createTextNode(($product['onDetay'] ? $product['onDetay'] : $product['name'])));
		$itemNode->appendChild($doc->createElement('g:image_link'))->appendChild($doc->createTextNode('http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $product['resim']));
		$itemNode->appendChild($doc->createElement('g:brand'))->appendChild($doc->createTextNode(($product['markaname'])));
		$itemNode->appendChild($doc->createElement('g:condition'))->appendChild($doc->createTextNode('new'));
		$itemNode->appendChild($doc->createElement('g:availability'))->appendChild($doc->createTextNode('in stock'));
		if ($product['fiyat']) {
			$price = str_replace(',', '', my_money_format('%i', YTLfiyat($product['fiyat'], $product['fiyatBirim'])));
			$itemNode->appendChild($doc->createElement('g:price'))->appendChild($doc->createTextNode($price . ' TRY'));
		}
...
function buildggXMLFile()
{
	...
	while ($d = my_mysql_fetch_array($q)) {
		...
		while ($d2 = my_mysql_fetch_array($q2)) {
			...
			for ($j = 1; $j <= 5; $j++) {
				$resimStr = 'resim' . ($j == 1 ? '' : $j);
				if ($d2[$resimStr]) $xml .= insertXMLData('FotografID' . $j, 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini . 'images/urunler/' . $d2[$resimStr]);
			}
			...
			$xml .= insertXMLData('UrunAciklaması', '<![CDATA[ ' . $d2['onDetay'] . '<br><br>' . str_replace('src="/', 'src="' . 'http' . (siteConfig('httpsAktif') == 2 ? 's' : '') . '://' . $_SERVER[HTTP_HOST] . $siteDizini, $d2['detay']) . ']]>');
