...
$sonuc = $sorgu->fetch();//sorgu çalıştırılıp veriler alınıyor
       ...
       if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
            ...
            if ($baslik <> "" && $icerik <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
             ...
             $sql = "UPDATE takim SET foto=:foto,facebook=:facebook,linkedin=:linkedin,google=:google;instagram=:instagram,baslik=:baslik,aktif=:aktif,sira=:sira, ustBaslik=:ustBaslik, icerik=:icerik WHERE id=:id;";             
            ...
            <div class="card-body">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" value="<?= $sonuc["facebook"] ?>" class="form-control" name="facebook"
                        placeholder="Facebook">
                    </div>
					<div class="form-group">
                        <label>İnstagram</label>
                        <input required type="text" value="<?= $sonuc["instagram"] ?>" class="form-control" name="instagram"
                        placeholder="İnstagram">
                    </div>
					<div class="form-group">
                        <label>Linkedin</label>
                        <input required type="text" value="<?= $sonuc["linkedin"] ?>" class="form-control" name="linkedin"
                        placeholder="Linkedin">
                    </div>
					<div class="form-group">
                        <label>Google</label>
                        <input required type="text" value="<?= $sonuc["google"] ?>" class="form-control" name="google"
                        placeholder="Google">
                    </div>
                    <div class="form-group">
